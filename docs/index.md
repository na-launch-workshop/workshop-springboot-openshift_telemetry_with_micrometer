...
1. Look at `src/resources/application.properties`
...
4. Now that the app should be deployed The question is should we see our traces or metrics in openshift.
...
- This module isn't intended to be much longer then 30 minutes.
- Most tasks will either by reviewing the UI components related to MicroMeter and OTEL.
- Other tasks will be uncommenting existing code.
